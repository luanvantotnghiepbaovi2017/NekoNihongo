...
class FlashCardSwipeViewController: UIViewController, AVSpeechSynthesizerDelegate {
    ...
    func initDataLesson() {
        ...
        switch self.numberFlashcardLesson {
            
        case 1:
            
            self.nekoCardArray =  AppDelegate.minnaNihongoLesson01Array.filter({ $0.nekoSound != "" })
            break
            
        case 2:
            
            self.nekoCardArray =  AppDelegate.minnaNihongoLesson02Array.filter({ $0.nekoSound != "" })
            break
