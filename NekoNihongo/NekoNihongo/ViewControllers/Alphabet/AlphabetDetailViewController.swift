...
class AlphabetDetailViewController: UIViewController {
    ...
    @IBAction func standardSpellingButton(_ sender: Any) {
        ...
        if self.alphabetItemDetail.nekoJapaneseCharacter.count == 2 {
            ...
            let AlphabetStrokeOrderDoubleCharacterViewController = AppDelegate.mainStoryBoard.instantiateViewController(withIdentifier: "AlphabetStrokeOrderDoubleCharacterViewController") as! AlphabetStrokeOrderDoubleCharacterViewController
            ...
            let AlphabetStrokeOrderViewController = AppDelegate.mainStoryBoard.instantiateViewController(withIdentifier: "AlphabetStrokeOrderViewController") as! AlphabetStrokeOrderViewController
